...
function MenuScene:initialize(name, w)
    ...
    title:addComponent(Rendering():addRenderable(TextRendering("E C H O B R E A K O U T"):setColor(204,147,147):setFont(large_font)))
    ...
    credits1:addComponent(Rendering():addRenderable(TextRendering("Press Enter to Select Level"):setColor(204,147,147):setFont(small_font)))
    ...
    credits2:addComponent(Rendering():addRenderable(TextRendering("by @BDFife and @JimFingal"):setColor(204,147,147):setFont(small_font)))
    ...
    menu_background:addComponent(Rendering():addRenderable(ShapeRendering():setColor(63, 63, 63, 255):setShape(RectangleShape:new(love.graphics.getWidth(), love.graphics.getHeight()))))
