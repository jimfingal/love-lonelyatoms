    ...
    if not song then 
        ...
        for y = 0, 60, 20 do
            ...
            for x=x_start, x_end, 100 do
                ...
                brick:addComponent(Rendering():addRenderable(ShapeRendering():setColor(this_color:unpack()):setShape(RectangleShape:new(100, 20))))
        ...
        for _, brickinfo in ipairs(config.bricks) do
            ...
            brick:addComponent(Rendering():addRenderable(ShapeRendering():setColor(brickinfo.r, brickinfo.g, brickinfo.b):setShape(RectangleShape:new(brickinfo.width, brickinfo.height))))
